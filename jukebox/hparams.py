...
prior_1b_lyrics_finetuned_kenhirai = Hyperparams(
    level=2,
    n_ctx=6144,
    prior_width=2048,
    prior_depth=72,
    ...
    prime_loss_fraction=0.4,
    single_enc_dec=True,
    restore_prior=f"{model_local_path}/logs/finetuned_1b_lyrics_kenhirai_50epc/checkpoint_latest.pth.tar",
    fp16_params=False,
    alignment_layer=63,
    alignment_head=0,
)
...
prior_1b_lyrics_finetune_roma_11708 = Hyperparams(
    ...
    prime_loss_fraction=0.4,
    single_enc_dec=True,
    restore_prior="/workspace/logs/finetuned_11708_20210711/checkpoint_epoch_20.pth.tar",
    fp16_params=False,
    alignment_layer=63,
    alignment_head=0,
    v3_ftune=True,
...
prior_1b_lyrics_finetune_roma_alignedlyrics = Hyperparams(
    ...
    prime_loss_fraction=0.4,
    single_enc_dec=True,
    restore_prior="/workspace/logs/prior_1b_lyrics_finetune_roma_alignedLyrics/checkpoint_epoch_-01.pth.tar",
    fp16_params=False,
    alignment_layer=63,
    alignment_head=0,
    jp_lyrics=False,
